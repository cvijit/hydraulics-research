...
if st.button('EDA Dashboard'):
    js = "window.open('https://hydrauliceda.shinyapps.io/hydraulics_dashboard/#section-histogram')"  # New tab or window
...
def get_classifier(clf_name, params):
    if clf_name == 'Logistic Regression':
        ...
        clf = lgb.LGBMClassifier(objective=params["objective"],metric=params["metric"],
                                 ...
                                 max_depth=params['max_depth'],colsample_bytree=params['colsample_bytree']),dtrain,100
    else:
