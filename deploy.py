...
def get_dataset(dataset_name):
    if dataset_name == 'Coolers':
        data = pd.read_csv('/Users/vijitchekkala/Desktop/final_model/Coolers_data.csv')
    elif dataset_name == 'Valves':
        data = pd.read_csv('/Users/vijitchekkala/Desktop//final_model/Valves_data.csv')
    elif dataset_name == 'Pump_Leakage':
        data = pd.read_csv('/Users/vijitchekkala/Desktop//final_model/Pump_data.csv')
    elif dataset_name == 'Hydraulic_Accumulator':
        data = pd.read_csv('/Users/vijitchekkala/Desktop//final_model/Accumulator_data.csv')
    else:
        data = pd.read_csv('/Users/vijitchekkala/Desktop//final_model/Stable_data.csv')
    X = data.iloc[:,0:17]
    y= data.iloc[:,-1]
    return X, y
